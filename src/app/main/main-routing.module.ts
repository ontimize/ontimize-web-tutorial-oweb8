...
import { ServiceExModule } from "./service-ex/service-ex.module";
...
export function loadServiceExModule(){
  return ServiceExModule;
}
...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'serviceEx', loadChildren: loadServiceExModule }
    ]
  }
];
